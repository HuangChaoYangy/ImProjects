# -*- coding: utf-8 -*-
# @Time    : 2023/6/14 22:07
# @Author  : liyang
# @FileName: log_utils
# @Software: PyCharm

import logging, time, colorlog, os
from config.base_dir import log_dir
...
class Bf_log(object):
    ...
    def __init__(self, name):
        ...
        # self.log_utils = logging.shutdown()   # 可关闭所有记录器，也就使得日志文件被关闭

        log_name = log_dir + "\\" + time.strftime("%Y-%m-%d", time.localtime()) + " all.log_utils"
        # print(log_name)
