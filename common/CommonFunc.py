...
class CommonFunc(object):
    ...
    #     print(configure)
    #     url_info = []
    #     if configure[0]['environment'] == "test":
    #         url_dic = configure[1]['test_url']
    #         url_info.extend([url_dic['client_url'], url_dic['backend_url']])
    #     elif configure[0]['environment'] == "extranet":
    #         url_dic = configure[1]['extranet_url']
    #         url_info.extend([url_dic['client_url'], url_dic['backend_url']])
    #     else:
    #         raise AssertionError('ERROR,this environment is not available')
    #     client_url = url_info[0]
    #     backend_url = url_info[1]
    #
